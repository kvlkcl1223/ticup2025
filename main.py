...
def undistort(frame):
    ...
    d=np.array([-4.64324478e-01 ,3.63196136e-01 , 1.15139053e-02,  6.06955229e-04,-1.63385810e+00])
    h,w=frame.shape[:2]
...
def is_equilateral_right_triangle(p1, p2, p3, angle_thresh=10, side_ratio_thresh=0.05):
