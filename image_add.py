        ...
        if question == 1:
            ...
            while True:
                ...
                if ret:
                    ...
                    # 设置窗口位置 (x, y)
                    cv2.moveWindow("frame", 160, 120)  # 将窗口移动到屏幕坐标(100,200)
                    # 显示图片
                    ...
                    # 设置窗口位置 (x, y)
                    cv2.moveWindow("thresh", 480, 240)  # 将窗口移动到屏幕坐标(100,200)
                    # 显示图片
                    cv2.imshow("thresh", cv2.resize(thresh, (320, 240)))

                    find_and_draw_outer_black_rectangle(thresh, frame,True,True)
